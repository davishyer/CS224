...
;
random:
		mov.w	r12,r14				; move low from R12 to R14
		call	#rand16				; store the random number
		sub.w	r14,r13				; max minus min
		inc.w	r13					; add one to R13
		push.w	r14					; callee-save low
		call	#myMod				; mod the random number with high
		pop.w	r14					; callee-save low
		add.w	r14,r12				; add low to mod to get 1-6
		ret							; return number to display
